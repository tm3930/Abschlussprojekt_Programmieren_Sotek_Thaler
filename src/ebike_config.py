...
class EbikeConfig:
    ...
    radius: float = field(init=False) #Radius wird nicht beim erstellen direkt übergeben, sondern in __post_init__ berechnet
    ...
    def __post_init__(self):
        ...
        logger.info("Daten aus der Ebike Konfiguration erfolgreich erfasst.")
